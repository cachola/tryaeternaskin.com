(function ($) {
    ...
    $.fn.formHandler = function (_selfOptions) {
        ...
        if (_selfOptions.type !== 'undefined' ) {
        ...
        _self.find('select[name=creditCardType]').change(function (e) {
            ...
            $.each(fields, function (index, field) {                
                if (cardType == 'paypal' || cardType == 'COD' || cardType == 'payu') {
        ...
        _self.submit(function (_event) {
            ...
            if (_selfOptions.type !== 'undefined' && _selfOptions.type != 'prospect' && _selfOptions.type != 'fullprospect' && _selfOptions.type != 'shipping'  && _selfOptions.type != 'upsell') {
                if (hasCardExpired()) {
