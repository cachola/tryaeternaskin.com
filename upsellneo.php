...
function sendApiRequestV2($url, $params = array())
{
    ...
    curl_setopt($curlSession, CURLOPT_USERPWD,  "revskin_api:fYJtPKDgmAQs4W");
...
function importOrder($params)
{
    ...
    $res = getResponseV2('POST', 'https://www.securefitnessportal.com/api/v1/new_order', $params);
    Tmplogger::log('requestsneo', print_r($res, true));
