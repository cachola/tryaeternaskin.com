...
<head>
  ...
  <link href="<?= $path['css'] ?>/inner.css?v=7" type="text/css" rel="stylesheet" />
  <link href="<?= $path['css'] ?>/btn-animation.css" type="text/css" rel="stylesheet" />
  <style>
    .chkbox {
...
<body data-mobile-id="5984" style="max-width: 600px; margin: 0 auto">
  ...
  <div id="app">
    <div class="checkout-page" id="pagecontainer">
      <div id="top-1">
        <center>
          <img src="<?= $path['images'] ?>/logo2-strips.png" style="width: 158px; margin: 6px 0 10px 0" />
        </center>
            ...
            <div style="width: 100%;">
              <div class="prod-box">
                <div class="ord-lft">
                  ...
                  <p class="ord-title">
                    ...
                    Pack<span3 id="span3-subs" style="display: none"><br />Sample</span3>
                  </p>
                </div>
                <div class="ord-right">
              ...
              <table class="cart-table" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td align="right">
                    <span class="package-price" style="font-weight: bold">$0.00</span>
                  </td>
                </tr>
              </table>
              <div class="devider-cp"></div>
              ...
              <table class="cart-table" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td align="right">
                    <span id="shippingprice" style="font-weight: bold">$9.95</span>
                  </td>
                </tr>
              </table>
              <div class="devider-cp expedited_div" style="display: none"></div>
              <table class="cart-table expedited_div" style="display: none" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="left">
                    <span>Rush S&H</span>
                  </td>
              ...
              <table class="cart-table bdr" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="right" class="total-txt">
                    <span class="totalprice" style="font-weight: bold">$9.95</span>
                  </td>
                </tr>
              </table>
            </div>
        ...
        <div id="shortcheckoutcontainer" style="max-width: 95%; margin: 0 auto">
          <form method="post" action="ajax.php?method=new_order_prospect" name="checkout_form" accept-charset="utf-8"
            enctype="application/x-www-form-urlencoded;charset=utf-8" id="frm">
            <input type="hidden" name="campaigns[1][id]" id="dynamic_input" value="1" />

            <label style="display: none;" for="payment_as_shipping" class="payment_as_shipping_label">
              <input type="checkbox" name="payment_as_shipping" id="payment_as_shipping" checked class="bill-inp" />
              <span>Billing same as Shipping</span>
            </label>
            <p style="display: none">
              <input type="radio" name="billingSameAsShipping" id="radio_1" value="yes" checked="" />
              YES
              <input type="radio" name="billingSameAsShipping" id="radio_2" value="no" />
              NO
            </p>
            <div class="billing-info" style="display: block; margin-bottom: 15px">
              <div class="billing-form">
                <div class="billing-title">Billing Information</div>

                <div class="form-holder">
                  <span>First Name: </span>
                  <input class="form-control" data-placement="auto left" name="firstName" id="firstName"
                    placeholder="First Name*" title="First Name" type="text"
                    data-error-message="Please enter your first name!" maxlength="25" />
                </div>

                <div class="form-holder" placeholder="Last Name*">
                  <span>Last Name: </span>
                  <input class="form-control" data-placement="auto left" name="lastName" id="lastName"
                    placeholder="Last Name*" title="Last Name" type="text"
                    data-error-message="Please enter your last name!" maxlength="25" />
                </div>

                <div class="form-holder">
                  <label>Address:</label>
                  <input class="form-control" data-placement="auto left" name="shippingAddress1" id="gmap_autocomplete"
                    placeholder="Address" title="Address" type="text" value=""
                    data-error-message="Please enter your address!" maxlength="25" />
                </div>

                <div class="form-holder">
                  <label>Zip Code:</label>
                  <input class="form-control" data-placement="auto left" name="shippingZip" id="zip"
                    placeholder="Zip Code*" title="Zip Code" type="tel" value=""
                    onKeyUp="javascript: this.value = this.value.replace(/[^0-9]/g, '');"
                    data-error-message="Please enter a valid zip code!" minlength="5" maxlength="5" />
                </div>

                <div class="form-holder">
                  <label>City:</label>
                  <input class="form-control" data-placement="auto left" name="shippingCity" id="city"
                    placeholder="City*" title="City" type="text" data-error-message="Please enter your city!"
                    maxlength="25" />
                </div>

                <p style="display: none">
                  <label>Shipping Country: </label>
                  <select style="line-height: normal" name="shippingCountry"
                    data-error-message="Please select your shipping country!" data-selected="US">
                ...
                <div class="form-holder">
                  <label>State:</label>
                  <input type="text" name="shippingState" id="shippingState" placeholder="State" class="form-control"
                    data-error-message="Please select your state!" />
                </div>
                <div class="form-holder">
                  <label>Phone:</label>
                  <input class="form-control required" data-placement="auto left" name="phone" id="fields_phone"
                    placeholder="Phone Number*" title="Phone Number" type="tel" value=""
                    data-error-message="Please enter a valid contact number!" maxlength="12">
                ...
                <div class="form-holder">
                  <label>Email:</label>
                  <input class="form-control required" data-placement="auto left" name="email" id='fields_email'
                    placeholder="Email*" title="Email" type="email" data-error-message="Please enter a valid email id!"
                    value="" maxlength="100">
                  <!-- <input
                      class="form-control"
                      data-placement="auto left"
            ...
            <div class="checkout-form-wrapper">
              <div class="form-holder">
                ...
                <input pattern="[0-9]*" type="tel" name="creditCardNumber" id="cc_number" data-threeds="pan"
                  class="form-control required masked" maxlength="16" placeholder="•••• •••• •••• ••••"
              ...
              <div class="form-holder" id="cvv">
                <label>CVV:</label>
                <input pattern="[0-9]*" type="tel" name="CVV" id="cc_cvv" class="form-control fcheckout-field required"
              ...
              <div class="sepa-block" style="display: none">
                ...
                <p>
                  ...
                  <span id="pin-msg">Please check your mobile for the pin that was sent to
                    you.</span>
                </p>
              </div>
              ...
              <div class="cvv-link left">
                <a href="javascript:void(0)" style="margin: 30px 0px 0px 17px; display: inline-block">CVV?</a>
              </div>
              <div class="clear"></div>
              <div class="cvv-image" style="display: none">
                <img alt="" src="<?= $path['images'] ?>/cvv.jpg" style="margin: 0px 0px 15px !important; width: 100%" />
              </div>
              <div id="rushtop">
                <input alt="Submit" border="0" class="pulsebutton cformbtn-default btn_pulse btn-click" id="submit_btn"
                  name="" src="<?= $path['images'] ?>/RushButton.jpg" style="width: 100%; outline: none" type="image"
                  value="submit" />
              </div>
        ...
        <div class="disclaimer">
          When you order a 14-Gummy Sample Pack of Keto Fire Gummies you will have 10 days to decide if the product is
          right for you. If you do nothing after 10 days you will be billed and shipped 1 bottle of Keto Fire Gummies at
          the regular price of $79.97. This will continue on a monthly basis until you cancel your subscription.
        </div>
        <div id="expedited_chk" style="    margin-top: 2px;margin-bottom: 5px;">
          <label for="free_trial">
            <input type="checkbox" name="" id="free_trial" class="chkbox bill-inp" style="margin-left: 5px;" checked />
            <span style="float: left">Get 1 Week Of FitnessXR & USADC
            </span>
          </label>
        </div>
        <div class="clear"></div>
        ...
        <div id="footer">
          ...
          <center>
            <ul class="terms-links">
              <li>
                <a href="javascript:void(0);" onClick="openNewWindow('../page-privacy.php','modal');">Privacy Policy
                  |</a>
              </li>
              <li>
                <a href="javascript:void(0);" onClick="openNewWindow('../page-terms.php','modal');">Terms and Conditions
                  |</a>
              </li>
              <li>
