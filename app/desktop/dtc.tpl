          ...
          <label class="spl-checkbox" style="vertical-align: top; text-align: center">
            ...
            <div class="form-box">
                <div class="inner">
                    ...
                    <form method="post" action="ajax.php?method=new_order_prospect" class="checkout-form"
                        name="checkout_form" accept-charset="utf-8"
                        ...
                        <div class="sameAsShipping" style="display: none;">
                            <label>
                  ...
                  data-error-message="Please enter your billing First Name!" /> -->
                                <input type="text" name="firstName" class="n-input form-control"
                                    placeholder="First Name" data-error-message="Please enter your First Name!" />
                            </div>
                            <div class="fields">
                  ...
                  data-error-message="Please enter your billing Last Name!" /> -->
                                <input type="text" name="lastName" class="n-input form-control" placeholder="Last Name"
                                    data-error-message="Please enter your Last Name!" />
                            </div>
                            <div class="fields" style="display: none">
                                <label>Country</label>
                                <select name="shippingCountry" class="n-select form-control" data-selected="US"
                  ...
                  id="billingAddress1" data-error-message="Please enter your billing Address!" /> -->
                                <input type="text" name="shippingAddress1" class="n-input form-control"
                                    placeholder="Address" id="gmap_autocomplete"
                            ...
                            <div class="fields">
                                ...
                                <input type="text" id="shippingAddress2" name="shippingAddress2"
                                    class="n-input form-control" placeholder="Apt / Suite #"
                                    data-error-message="Please enter your address2!" />
                            </div>
                            <div class="fields">
                                <label>City</label>
                                <input type="text" name="shippingCity" class="n-input form-control" placeholder="City"
                                    id="city" data-error-message="Please enter your city!" />
                            </div>
                            <div class="fields">
                                <label>State</label>
                                <input type="text" name="shippingState" class="n-select form-control"
                                    placeholder="State" id="shippingState"
                                    data-error-message="Please select your state!" />
                            </div>
                            <div class="fields">
                                <label>Zip</label>
                                <input type="tel" name="shippingZip" class="n-input form-control" placeholder="Zip Code"
                                    data-error-message="Please enter a valid zip code!" maxlength="5"
                                    data-min-length="5" id="zip" />
                            </div>

                            <div class="fields">
                                <label>Phone</label>
                                <input type="tel" name="phone" class="n-input form-control required" placeholder="Phone"
                                    data-error-message="Please enter a valid contact number!" maxlength="15"
                                    id="phone" />
                            </div>

                            <div class="fields">
                                <label>Email Address</label>
                                <input type="email" name="email" class="n-input form-control required"
                                    placeholder="Email" data-error-message="Please enter a valid email!" />
                            </div>
                        ...
                        <div class="fields">
                            ...
                            <input type="tel" name="creditCardNumber" id="card_number"
                                class="required n-input clearable formfield ib" maxlength="16"
                        ...
                        <div class="fields">
                            ...
                            <a href="javascript:void(0);" class="bottomhref"
                                onClick="javascript:openNewWindow('cvv.html','modal');"><img
                                    src="<?= $path['images'] ?>/cvv-img.png" alt="cvv icon"
                                    style="vertical-align: middle; margin-left: 12px; width: 84px" /></a>
                        </div>
                        <div class="fields">
                            <div class="disclaimer" style="padding: 10px 10px 0 10px">
                                ...
                                <a href="javascript:void(0);"
                                    ...
                                    style="color: inherit; text-decoration: underline; cursor: pointer">Terms &amp;
                                    Conditions</a>.
                            </div>
                        </div>
