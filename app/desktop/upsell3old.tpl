...
<div class="up-bnr up4-bnr">
    <div class="container">
        ...
        <div class="cont-bx">
            <div class="up-leftBx">
                <p class="ups1-txt1" style="color:#0176a1;">Add FitnessXR 7-Day
                FREE Trial</p>
                <!-- <div class="up-rghtBx up4-rghtBx forMob"> -->
                    <img src="<?= $path['images']; ?>/up4-prod.png" class="up4-prod  forMob">
                <!-- </div> -->
                <!-- <div class="up-rghtBx up4-rghtBx hide-mob"> -->
                    <img src="<?= $path['images']; ?>/up4-desk-prod.png" class="up4-prod hide-mob">
                <!-- </div> -->
                <!-- <ul class="up-s1-list up4-s1-list">
                    <li>Customizable Nutrition Plans</li>
                    <li>Specialized Workout Videos</li>
                    <li>Healthy Lifestyle Guide</li>
                </ul> -->
                
                <div class="up-prc-sec">
                    <div class="prc-Dv">
                        <p class="prc-txt1">Retail Price</p>
                        <p class="rglr-prc"><span class="strikeout">$19.99</span></p>
                    </div>
