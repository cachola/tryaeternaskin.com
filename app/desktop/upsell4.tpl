...
<body>
  ...
  <div id="wrapper">
    ...
    <div class="wait">
      ...
      <p> Add Rush Processing To Ensure <br class="br-mobile">Fastest Delivery Possible.</p>
        ...
        <section class="offer-block">
          <div class="offer-inner">
            ...
            <div class="offer-product">
              ...
              <img src="<?= $path['images'] ?>/up3-prod.png" alt="">
            </div>

            <div class="offer-copy">
              <h2 class="offer-top">Add Rush Processing & <br> 
Get Your Order Immediately</h2>
              <p class="offer-red">Avoid Shipping Delays</p>
              <p class="offer-with">Get Your Order <br>Processed First</p>
              <p class="offer-title">Faster Delivery for <br>Faster Results!</p>
       ...
       <p class="offer-line2">This Price Will Never Be <br>Available Again</p>
            </div>
          </div>
        </section>
        <input type="submit" id="submit-btn" value="Complete Checkout" />
        <div class="bottom">
          <a href="authorize.php"><i class="fa fa-times-circle"></i> <span>No thanks, I decline this offer</span></a>
        </div>
        <p id="loading-indicator" style="display:none;">Processing...</p>
