...
class M1billing extends BaseCrm
{
    ...
    protected $requiredPayload = array(
        ...
        'newOrderWithProspect' => array(
            ...
            'card_exp_month', 'card_exp_year', 'slug', 'merchant_id', 'items','order_eci','order_xid','order_cavv','3ds_redirect_url'
        ),
        'newOrder' => array(
            ...
            'bill_city', 'bill_state', 'bill_zipcode', 'items','order_eci','order_xid','order_cavv','3ds_redirect_url'
        ),
        'newOrderCardOnFile' => array(
            'user_id', 'user_password', 'campaign_id', 'offer_id',
            'order_id', 'card_cvv', 'items', 'merchant_id','order_eci','order_xid','order_cavv','3ds_redirect_url'
        ),
        'orderView' => array(
