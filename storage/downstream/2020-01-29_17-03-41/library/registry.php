...
return array(
    ...
    'hooks'           => array(
        ...
        array(
            'event'    => 'afterCrmPayloadReady',
            'callback' => "Application\Hook\Events@updateCustomerIdForDownsell",
            'priority' => 1000,
        ),
        array(
            'event'    => 'afterAnyCrmRequest',
    ...
    'systemConstants' => array(
        ...
        'VIEW_DIR'                => 'app',
        'REMOTE_URL'              => 'https://framework.201clicks.com/',
        'REMOTE_DOWNLOAD_URL'     => 'https://framework.201clicks.com/download.php',
        'REMOTE_LIST_URL'         => 'https://framework.201clicks.com/extension.list.json',
        '201CLICKS_URL'           => 'https://api.201clicks.com',
