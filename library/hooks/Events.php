...
class Events
{
    ...
    private function storeRequestResponseData()
    {
        try
        {
            ...
            $insertData['rawPayload'] = CrmResponse::get('rawPayload');
            $insertData['rawResponse'] = CrmResponse::get('rawResponse');
    ...
    public function doFallbackConfig()
    {
        ...
        if(empty($configSettings))
        {
            ...
            $lastUpdatedKey = array_shift(array_keys(array_reverse($oldVersions)));
