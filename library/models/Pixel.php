...
class Pixel
{
    ...
    public function __construct()
    {
        ...
        $this->previousStepId   = (int)  $this->currentStepId - 1; //Session::get('steps.previous.id');
        ...
        return preg_replace_callback(
            ...
            function ($data) {
                if ($data[1] === 'order_id' || $data[1] === 'orderId') {
                    $orderId = Session::get('confirm_paypal_order_id', '');
                    if ($orderId!='') {
                        return $orderId;
                    }
                    $orderId = Session::get('orderIdCustom', '');
                    if ($orderId!='') {
                        return $orderId;
                    }
                ...
                if ($data[1] === 'order_total' || $data[1] === 'orderTotal') {
                    ...
                    $orderTotal = Session::get('orderTotalCustom', 0.00);
                    return $orderTotal;
                }
