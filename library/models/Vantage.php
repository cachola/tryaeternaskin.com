...
class Vantage extends BaseCrm
{
    private $localEncKey = 'd0a7e7997b6d5fcd55f4b5c32611b87cd923e88837b63bf2941ef819dc8ca282';

    private $currentStepId, $currentConfigId, $configuration, $tableName, $dbConnection,$crmResponseLog;
    ...
    public function __construct($crmId)
    {
        ...
        print(" construct session get1 \n");
        $this->currentStepId   = (int)Session::get('steps.current.id');
        print(" construct session get2 \n");
        ...
        try {
            ...
            print(" construct catch \n");
            $this->configuration = null;
        }

        $this->tableName = 'ketofireburn_v6';
        print("end construct try \n");
    }
    ...
    private function updateCurstomerInPayload()
    {
    ...
    sendDBLogs($url, $response, $payload)
    {
        ...
        $dbConnection->table('v6HttpLog')->insert($data);
    }
