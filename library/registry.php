...
return array(
    ...
    'hooks'           => array(
        ...
        array(
            'event'    => 'pageLoad',
            'callback' => 'Application\Hook\Events@doFallbackConfig',
            'priority' => 1001,
        ),
    ),
    'crons'           => array(
    ...
    //     'core_validator'    => 'assets/js/validator.min.js',
    //     'core_codebase'     => 'assets/js/codebase.min.js',
    //     'core_form_handler' => 'assets/js/form_handler.min.js',
    //     'core_app'          => 'assets/js/app.min.js',
    //     'core_outro'        => 'assets/js/outro.min.js',
    // ),
    'scripts'         => array(
        'promise.min'       => 'assets/js/promise.min.js',
        'jquery.min'        => 'assets/js/jquery.min.js',
