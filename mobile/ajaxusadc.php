...
function sendApiRequestV2($url, $params = array())
{
    ...
    curl_setopt($curlSession, CURLOPT_USERPWD,  "ketofiregummies_usadc_api:PZTHbbTHaMRKzz");
...
function importOrder($params)
{
    ...
    $res = getResponseV2('POST', 'https://api.usadc-core.com/api/v1/new_order', $params);
    Tmplogger::log('requestsusadc', print_r($res, true));
