...
<head>
    ...
    <meta charset="utf-8" />
    <meta name="description" content="Pinnacle Science Testo Boost" />
    <title>Pinnacle Science Stamin-Up</title>
    <meta name="viewport" content="width=800, user-scalable=0" />
    <link rel="stylesheet" href="app/desktop/css/app.css" type='text/css' />
    <link rel="stylesheet" href="app/desktop/css/amino_css/upsell4.css" />
...
<body>
    ...
    <header>
        <div class="upsell-container">
            <div class="logo"><img src="app/desktop/images/amino_images/logo.png"></div>
        </div>
    </header>

    <div class="upsell-container">
        <div class="progress">
            <img src="app/desktop/images/amino_images/pro.png">
            <span class="overText">
                <ul>
        ...
        <div class="mid-container">
            <center>
                <h3 style="color:#ff0000">WAIT! Your Order is Not Complete...</h3>
                <p class="fSize18 mb20"><strong>Male Enhancement is only half the battle...<br>Make sure you have the
                        <span style="color:red">stamina and desire</span> to keep her satisfied!</strong></p>
            </center>
            <div class="upsell-wrapper" id="container">
                <div class="left">
                    <img src="app/desktop/images/amino_images/man-prod.png" class="">
                    <img src="app/desktop/images/amino_images/CAN-Step-upsell2.png" class="up2">
                </div>
                <div class="right">
                    <h4 class="center">Increase your sexual performance <br>with Pinnacle Science Stamin-Up</h4>
                    <ul class="fSize18">
                        <li><strong>Increase your sex drive</strong></li>
                        <li><strong>Have the energy for peak performance</strong></li>
                        <li><strong>Don't leave her wanting more!</strong></li>
                    </ul>
                    <p class="underLine center"><strong>New Customer Discount</strong></p>
                    <div class="offerSection">
                        <div class="flex-space">
                            <div>Was</div>
                            <div>Now Only</div>
                        </div>
                        <div class="flex-space mb5">
                            <div><span class="lineThgough-red"><strong>$39.95</strong></span></div>
                            <div><span class="green"><strong>$29.95</strong></span></div>
                        </div>
                        <div class="center italic"><strong>Save 25%</strong></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="secureBit">
            Limited Offer: Only <span class="inline"><img src="app/desktop/images/amino_images/digit.png"></span>
            Bottles Remaining
        </div>

        <form name="is-upsell" id="kform" class="is-upsell" accept-charset="utf-8"
            enctype="application/x-www-form-urlencoded;charset=utf-8">
            <input type="hidden" name="no_use" id="no_use" value="utf-8" />
            <input type="submit" id="submit_butt" class="upsell3-btn"
                value="Yes, I want to increase my sexual performance >">
        </form>

        <p id="loading-indicator" style="display:none;">Processing...</p>

        <div class="signature">
            <img src="app/desktop/images/amino_images/sign.png">
        </div>

        <center>
            <p class="disclose"><a href="thank-you.php">No thanks, I’m am not interested
                    in a satisfying sex life</a></p>
        </center>

    </div>

    <footer>
        <p>Customer Service: <a href="tel:888-506-2480">888-506-2480</a></p>
        <p class="footerP">
            <a href="javascript:void(0);" onclick="javascript:openNewWindow('terms.php', 'modal');">Terms &amp;
                Conditions</a> |
            <a href="javascript:void(0);" onclick="javascript:openNewWindow('privacy.php', 'modal');">Privacy Policy</a>
            |
            <a href="javascript:void(0);" onclick="javascript:openNewWindow('contact.php', 'modal');">Contact</a>
        </p>
        <p>&copy; Copyright 2022. Pinnacle Science Products - All Rights Reserved</p>
    </footer>
    ...
    <script>
        $('#submit_butt').on('click', function(e) {
            // $('#kform').submit();
            e.preventDefault();
    ...
    <script>
        (function(doc) {
            ...
            if (navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPod/i)) {
                document.head.insertAdjacentHTML('beforeEnd',
                    '<meta name="viewport" content="width=950, user-scalable=0" />');
            } else if (navigator.userAgent.match(/iPad/i)) {
                document.head.insertAdjacentHTML('beforeEnd',
                    '<meta id="viewport" name="viewport"content="width=800, user-scalable=0">');
            }
